...
/**
 * The class which implements in a good way getting remote address of a client.
 * DO NOT use request().remoteAddress() from play.mvc.Http.RequestHeader. It gives a wrong answer!
